...
const datatable = new DataTable('#tablaProductos', {
    ...
    columns: [
        ...
        },
        {
            ...
            render: (data, type, row, meta) => {
                let html = `
                <button class='btn btn-warning modificar' data-id="${data}" data-nombre="${row.nombre}" data-precio="${row.precio}" data-saludo="hola mundo"><i class='bi bi-pencil-square'></i>Modificar</button>
...
const traerDatos = (e) => {
    ...
    formulario.pro_id.value = elemento.id
    formulario.nombre.value = elemento.nombre
    formulario.precio.value = elemento.precio
